                            ...
                            <a href="#">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p>u acho que vai dar pra passar de boa. Eu to achando fácil.</p>
                                    </div>
                                </div>
                            </a>
                        </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Friends <!--<small>Sun and Ascendant in Aries</small>-->
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Friendship
                            </li>
                        </ol>
                    </div>
                </div>
